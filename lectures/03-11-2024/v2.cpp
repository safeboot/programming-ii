...
public:
    ...
    void unos(const char* naziv, int brojRedova, int brojKolona) {
        ...
        setNaziv(naziv);
        brojRedova = _brojRedova;
        brojKolona = _brojKolona;
...
public:
    ...
    //Z3.3
    const char* getIme() const { return nullptr; } //implementirati funkciju
    const char* getPrezime() const { return nullptr; } //implementirati funkciju
    Datum getDatumRodjenja() const { return *_datumRodjenja; }
    bool getSpol() const { return false; } //implementirati funkciju
    const char* getRadnoMjesto() const { return nullptr; } //implementirati funkciju
    const char* getGrad() const { return ""; } //implementirati funkciju
    const char* getEmail() const { return ""; } //implementirati funkciju
